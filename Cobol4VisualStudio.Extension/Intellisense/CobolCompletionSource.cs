...
namespace Cobol4VisualStudio.Extension.Intellisense {
...
[Export(typeof(IVsTextViewCreationListener))]
    ...
    internal sealed class CobolVsTextViewCreationListener : IVsTextViewCreationListener {
    ...
    public class CobolCompletionSourceProvider : ICompletionSourceProvider {
        public ICompletionSource TryCreateCompletionSource(ITextBuffer textBuffer) {
            return new CobolCompletionSource(textBuffer);
        }
    }

    public class CobolCompletionSource : ICompletionSource {
